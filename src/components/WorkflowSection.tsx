...
const WORKFLOW_STEPS: WorkflowCardData[] = [
  {
    ...
    description: 'Search 500,000+ vetted Creators by platform, niche, audience, and budget. See verified engagement rates and demographics before you commit. Spend less time searching and more time running campaigns.',
    pills: ['Vetted creators', 'Detailed audience demographics', 'Free to search'],
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        {/* Search Bar Input */}
        <div className="bg-gray-100/90 rounded-full px-4 py-2.5 text-xs text-gray-600 flex items-center gap-2 border border-gray-200/60 shrink-0">
  ...
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        {/* Campaign Header */}
        ...
        {/* Campaign Card Box */}
        <div className="bg-gray-50/90 rounded-2xl p-4 border border-gray-200/60 my-auto">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2 overflow-hidden">
              <img className="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover" src={lettersOfTravelImg} alt="Grischa" />
              <img className="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover" src={paolaSantanaImg} alt="Paola" />
              <img className="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover" src={alicjaWerniewiczImg} alt="Alicja" />
              <img className="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover" src={marimiqadzzeImg} alt="Mariam" />
              <img className="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover" src={joanneBladesImg} alt="Joanne" />
            </div>
  ...
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        ...
        {/* Chat Message Thread */}
        <div className="space-y-2.5 py-1 text-xs my-auto">
          <div className="bg-gray-100/90 text-gray-800 rounded-2xl rounded-tl-xs px-3.5 py-2.5 max-w-[88%] font-normal">
            Hi! Love the brief — can we extend usage rights to 90 days?
          </div>

          <div className="bg-gray-900 text-white rounded-2xl rounded-tr-xs px-3.5 py-2.5 max-w-[88%] ml-auto font-normal">
  ...
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        ...
        {/* Escrow Banner */}
        <div className="bg-gray-50 rounded-xl p-3.5 border border-gray-200/60 my-auto">
          <p className="text-xs text-gray-700 font-medium">You have 1 hour to accept or decline this order.</p>
          <a href="#extend" onClick={(e) => e.preventDefault()} className="text-[11px] font-semibold text-gray-500 underline mt-1 block hover:text-gray-900">
            Request Extension
          </a>
        </div>
        ...
        <div className="space-y-2 shrink-0">
          <button className="w-full bg-gray-900 text-white font-semibold text-xs py-2.5 rounded-xl shadow-xs hover:bg-black transition-colors">
            Mark Order Complete
          </button>
          <button className="w-full bg-gray-100 text-gray-700 font-semibold text-xs py-2.5 rounded-xl border border-gray-200 hover:bg-gray-200 transition-colors">
            Request Revision
          </button>
        </div>
      </div>
  ...
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        ...
        <div className="w-full h-24 my-auto">
  ...
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        ...
        <button className="w-full mt-2 bg-rose-50 text-rose-700 font-bold text-xs py-2.5 rounded-xl hover:bg-rose-100 transition-colors flex items-center justify-center gap-1 shrink-0">
          + Invite teammate
        </button>
      </div>
    ),
  },
  {
    ...
    renderGraphic: () => (
      <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-lg border border-gray-100 flex flex-col justify-between w-full h-[385px] overflow-hidden">
        <div>
          <div className="font-bold text-gray-900 text-xs sm:text-sm mb-2.5">Your creator roster</div>

          {/* Filter Pills */}
          <div className="flex gap-1.5 mb-3.5 text-[10px] font-semibold">
            <span className="bg-gray-900 text-white px-2.5 py-0.5 rounded-full">All · 28</span>
            <span className="bg-gray-100 text-gray-600 px-2.5 py-0.5 rounded-full">Marketplace · 18</span>
            <span className="bg-rose-50 text-rose-600 px-2.5 py-0.5 rounded-full">Off-platform · 10</span>
          </div>
    ...
    <section className="w-full pt-10 sm:pt-14 pb-6 sm:pb-8 bg-white">
      ...
      <div className="w-full max-w-[1080px] mx-auto px-4 sm:px-6 lg:px-0">
        ...
        <div className="hidden lg:block">
          ...
          <div className="w-full max-w-[1080px] mx-auto bg-[#dcdffb] rounded-[32px] p-8 sm:p-10 md:p-12 shadow-sm transition-all duration-300 min-h-[500px] flex items-center">
            <div className="grid grid-cols-12 gap-8 md:gap-10 items-center w-full">
              {/* Left Content Column */}
              ...
              <div className="col-span-5 w-full flex justify-center lg:justify-end">
